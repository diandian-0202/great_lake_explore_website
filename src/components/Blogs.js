...
function Blogs({ scrollPositionHeader}) {
  return (
    <div className="center-div">
        <Title scrollPositionHeader={scrollPositionHeader} text="Development Blogs"/>
        <div>
            <div className="content-box">
                ...
                <p className="dev-blog-text">
                During the week, we designed the outline of the landscape, added fishing 
        ...
        <div>
            <div className="content-box">
                ...
                <p className="dev-blog-text">
                We selected the specific animals that we would like to represent in the game 
                as well as made the board representing the food chain with all the connections 
                between the the animals. We also added rain to our world, and enhanced the 
                landscape through modeling and the addition of trees. The user also has the ability 
                to teleport between lakes, and information appears when the user 
                catches a fish.
                </p>
            </div>
        </div>
